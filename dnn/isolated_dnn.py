...
training_data_folder_path = "/media/david/Elements/David/deep/final_data/labelled/training/"
    ...
    while True:
        for i in range(len(data_list)//minibatch_size):
            ...
            for sample in minibatch:
                ...
                flat_and_cut_sample_x = np.reshape(sample_x[offset:power_cutoff + offset, :],
                                                   [1, power_cutoff * sample_x.shape[1]])
                if batch_x is None:
